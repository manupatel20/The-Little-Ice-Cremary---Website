...
<div class="describe">
    <h2>BUTTER SCOTCH</h2>
        <p>The amazing taste of butterscotch makes it
            <br/> the tastiest ice cream of all time.
        <br/>Tame your sweet cravings with this amazing 
        <br/>sweet delight.</p>
         <h3>Rs. 160</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="BUTTER SCOTCH">
...
<div class="photo">
    <img src="../images/butter-scotch-pack.png" width="750px" height="400px">
</div>