...
<div class="describe">
    <h2>MAVA BADAM</h2>
        <p>As royal as the name, made with pure mava and pieces
            <br/> of badam. Ice Cream is a great companion for all 
            <br/>those moments you are by yourself...</p>
         <h3>Rs. 175</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="MAVA BADAM">
...
<div class="photo">
    <img src="../images/mava-badam-pack.png" width="750px" height="400px">
</div>