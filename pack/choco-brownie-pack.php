...
<div class="describe">
    <h2>CHOCO BROWNIE</h2>
        <p>Indulge in a rich and smooth low-calorie 
            <br/>chocolate low-fat ice cream that comes with
            <br/> brownie crumbles and a caramel swirl with no 
            <br/>artificial sweetener.</p>
         <h3>Rs. 180</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="CHOCO BROWNIE">
...
<div class="photo">
    <img src="../images/choco-brownie-pack.png" width="750px" height="400px">
</div>