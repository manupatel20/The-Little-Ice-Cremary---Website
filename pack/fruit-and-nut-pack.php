...
<div class="describe">
    <h2>FRUIT AND NUT</h2>
        <p>Utterly delicious ice cream made from fresh
            <br/> milk available in a wide range of flavours 
            <br/>and packs.</p>
         <h3>Rs. 170</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="FRUIT AND NUT">
...
<div class="photo">
    <img src="../images/fruit-and-nut-pack.png" width="750px" height="400px">
</div>