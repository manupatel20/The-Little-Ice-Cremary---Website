...
<div class="describe">
    <h2>SIGNATURE PAN</h2>
        <p>Real Kasturi pan, gulkand and whole pan masala in 
          <br/>rich ice cream…... A perfect Indian treat.</p>
         <h3>Rs. 185</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="SIGNATURE PAN">
...
<div class="photo">
    <img src="../images/signature-paan-havmor.png" width="750px" height="400px">
</div>