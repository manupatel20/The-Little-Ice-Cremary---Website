...
<div class="describe">
    <h2>RINGO BINGO</h2>
        <p>A little champ chocolate ice cream topped
            <br>with freezed vanilla cream, filled in a crunchy cone.
        </p>
...
<h3>Rs. 35</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="RINGO BINGO">
...
<div class="photo">
    <img src="./images/Topo-Cones-Ringo-Bingo.png" width="700px" height="570px">
</div>
