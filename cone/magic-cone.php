...
<div class="describe">
    <h2>MAGIC CONE</h2>
        <p>A small serving of pista ice cream filled in a crunchy cone.
        </p>
...
<h3>Rs. 45</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="MAGIC CONE">
...
<div class="photo">
    <img src="./images/magic-cone.png" width="700px" height="600px">
</div>
