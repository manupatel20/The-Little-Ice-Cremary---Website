...
<div class="describe">
    <h2>CHOCO NUTS</h2>
        <p>It is new ice cream flavor Studded with candied
            <br>pecans in each bite.This  icecream is pure 
            <br>decadence with its ultra creamy texture almond-fudge-scoop
            <br> prominent caramelized brown sugar notes. 
        </p>
...
<h3>Rs. 30</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="CHOCO NUTS">
...
<div class="photo">
    <img src="./images/Topo-Cones-Havmor.png" width="700px" height="600px">
</div>
