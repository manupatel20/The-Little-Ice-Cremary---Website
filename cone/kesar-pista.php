...
<div class="describe">
    <h2>KESAR PISTA</h2>
        <p>A crunchy cone filled with kesar pista
            <br> ice cream topped with kesar sauce and pistas.
        </p>
...
<h3>Rs. 25</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="KESAR PISTA">
...
<div class="photo">
    <img src="../images/kesar-pista.png" width="600px" height="440px">
</div>
