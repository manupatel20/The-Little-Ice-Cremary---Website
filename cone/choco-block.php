...
<div class="describe">
    <h2>CHOCO BLOCK</h2>
        <p>A crunchy cone filled with ball shaped 
            <br>chocolate ice cream coated with chocolate.
            <br>It is topped with dark and white button 
            <br>chocolates and roasted cashews.
        </p>
...
<h3>Rs. 50</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="CHOCO BLOCK">
...
<div class="photo">
    <img src="./images/choco-block.png" width="600px" height="570px">
</div>
