...
<div class="describe">
    <h2>BELGIAN CHOCOLATE</h2>
        <p>Belgian-chocolate ice cream is made up of
            <br> dark chocolate wafer biscuit cone, topped with chocolate chips.
        </p>
...
<h3>Rs. 40</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="BELGIAN CHOCOLATE">
...
<div class="photo">
    <img src="./images/belgian-chocolate-cone.png" width="600px" height="570px">
</div>
