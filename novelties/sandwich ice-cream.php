...
<div class="describe">
    <h2>SANDWICH ICE-CREAM</h2>
        <p>Milky vanilla ice cream sandwiched between crunchy biscuits.
</p><br/></br>
        <h3>Rs. 70</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="SANDWICH ICE-CREAM">
...
<div class="photo">
    <img src="../images/Sandwich-Ice-Cream.png" width="550px" height="450px">
</div>