...
<div class="describe">
    <h2>ITALIAN CASSATA</h2>
        <p>3 different ice cream with eggless vanilla cake<br/> and cashews on top.
</p><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="ITALIAN CASSATA">
...
<div class="photo">
    <img src="../images/Italian-Cassata-cake.png" width="800px" height="600px">
</div>