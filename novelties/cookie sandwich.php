...
<div class="describe">
    <h2>COOKIE SANDWICH</h2>
        <p>Chocolate chip cookies served with chocolate ice cream and almonds.
...
<h3>Rs. 120</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="COOKIE SANDWICH">
...
<div class="photo">
    <img src="../images/chocolate-Cookie-Sandwich.png" width="600px" height="440px">
</div>