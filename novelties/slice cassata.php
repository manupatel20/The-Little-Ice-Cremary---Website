...
<div class="describe">
    <h2>SLICE CASSATA</h2>
        <p>Combination of 3 ice cream with eggless vanilla cake,</br> cashew and tutti frutti.
</p><br/></br>
      ...
      <h3>Rs. 100</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="SLICE CASSATA">
...
<div class="photo">
    <img src="../images/Slice-Cassata.png" width="800px" height="500px">
</div>