...
<div class="describe">
    <h2>DOUBLE SPIN</h2>
        <p>A great combination of vanilla and luscious fruit in a spin.
</p><br/></br>
       ...
       <h3>Rs. 70</h3><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="DOUBLE SPIN">
...
<div class="photo">
    <img src="../images/double-spin-ice-cream.png" width="650px" height="440px">
</div>