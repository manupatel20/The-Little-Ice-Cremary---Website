...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./almond-fudge-scoop.css">
...
<div class="describe">
    <h2>ALPHANSO MANGO</h2>
        <p>Enjoy the goodness of real fruit in a delicious creamy dessert.
            <br/> With creamy delights every scoop is a celebration.
            <br/>Real fruit pulp, fruit pieces and fruit sauces.
            <br/>All sourced with care. Dig into a creamy delight and let
             <br/>the range of lively flavours satisfy your creamy fruit craving </p>
        <h3>Rs. 170</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="ALPHANSO MANGO">
...
<div class="photo">
    <img src="./images/alphanso-mango-cup.png" width="600px" height="500px">
</div>
