...
<div class="describe">
    <h2>KAJU DRAKSH</h2>
        <p>Kaju draksh ice cream is one of the popular ice creams in Gujarat
            <br/> made with cashew and raisins. Simple no-churn ice cream  
            <br/>flavored with milk powder, cashews and raisins. This Kaju 
            <br/>draksh Ice Cream is a unique ice cream flavor to enjoy this summer.
        </p>
        <h3>Rs. 180</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="KAJU DRAKSH">
...
<div class="photo">
    <img src="../images/kaju-draksh-cup.png" width="600px" height="500px">
</div>