...
<div class="describe">
    <h2>ANJEER PISTA</h2>
        <p>Anjeer pista is an Indian ice cream made with dried figs, 
            <br/>heavy cream and evaporated milk without using condensed milk. 
            <br/>It is one of the easiest dried fig dessert recipes.
        </p>
        <h3>Rs. 185</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="ANJEER PISTA">
...
<div class="photo">
    <img src="../images/anjeer-cup.png" width="600px" height="500px">
</div>