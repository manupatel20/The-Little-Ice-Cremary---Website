...
<div class="describe">
    <h2>RAJBHOG</h2>
        <p>Made from real milk, premium nuts and flavours, Vadilal Rajbhog Ice 
            <br/>Cream comes in a premium packaging. This ice cream has a
            <br/> mouth-watering and delicious taste that gives you an authentic
            <br/> Indian flavour.
        </p>
        <h3>Rs. 165</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="RAJBHOG">
...
<div class="photo">
    <img src="../images/rajbhog-cup.png" width="600px" height="500px">
</div>