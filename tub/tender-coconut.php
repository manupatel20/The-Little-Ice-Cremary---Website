...
<div class="describe">
    <h2>TENDER COCONUT</h2>
        <p>100% natural ice cream made from fresh tender coconut.
            <br/> It contains no preservatives, no added colours or stabilisers. 
            <br/>It is made from pure milk. It comes in hygienic and tamper-proof 
            <br/>packaging. It comes with a perfect balance of taste and quality.
        </p>
        <h3>Rs. 180</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="TENDER COCONUT">
...
<div class="photo">
    <img src="../images/tender-coconut-cup.png" width="600px" height="500px">
</div>