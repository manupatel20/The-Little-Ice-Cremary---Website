...
<div class="describe">
    <h2>TRIPLE CHOCOLATE</h2>
        <p>Creamy black chocolate ice cream coated with crispy<br/> dark chcolate and crackles.
</p><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="TRIPLE CHOCOLATE">
...
<div class="photo">
    <img src="../images/Triple-Chocolate.png" width="700px" height="550px">
</div>