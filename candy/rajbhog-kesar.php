...
<div class="describe">
    <h2>RAJBHOG KESAR</h2>
        <p>Saffron flavoured ice cream kulfi coated with rich white chocolate,</br> cashwenuts and pista.
</p><br/></br>
...
<?php
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="RAJBHOG KESAR">
...
<div class="photo">
    <img src="../images/Rajbhog-kesar.png" width="550px" height="500px">
</div>