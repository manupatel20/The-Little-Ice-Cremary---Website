...
<div class="describe">
    <h2>CRUNCHY BITE</h2>
        <p>Saffron flavoured ice cream candy coated with rich white chocolate,</br> cashwenuts and pista.
</p><br/></br>
        <h3>Rs. 50</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="CRUNCHY BITE">
...
<div class="photo">
    <img src="../images/crunchy-bite.png" width="550px" height="400px">
</div>