...
<div class="describe">
    <h2>SHAHI KULFI</h2>
        <p>Pista ice cream generously coated with white chocolate </br>and irani pista chunks.
</p><br/></br>
      ...
      <?php
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="SHAHI KULFI">
...
<div class="photo">
    <img src="../images/shahi-kulfi.png" width="700px" height="550px">
</div>