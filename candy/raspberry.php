...
<div class="describe">
    <h2>RASPBERRY</h2>
        <p>A crazy combination of raspberry syrup <br/>and vanilla ice cream.
</p><br/></br>
       ...
       <?php
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="RASBERRY">
...
<div class="photo">
    <img src="../images/rasberry.png" width="600px" height="500px">
</div>