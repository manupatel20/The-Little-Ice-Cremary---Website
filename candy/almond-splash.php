...
<div class="describe">
    <h2>ALMOND SPLASH</h2>
        <p>A small serving of almond flavored ice cream topped </br>with butterscotch crunch.
</p><br/></br>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="ALMOND SPLASH">
...
<div class="photo">
    <img src="../images/almond-splash.png" width="750px" height="500px">
</div>