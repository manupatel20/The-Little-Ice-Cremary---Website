...
<div class="describe">
    <h2>VANILLA SCOOP</h2>
        <p>It has an irresistible rich vanilla flavour 
            <br/>making a delicious dessert. This ice cream is 
            <br/>made with the finest fragrant vanilla so 
            <br/>that it is rich and creamy.</p>
         <h3>Rs. 60</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="VANILLA SCOOP">
...
<div class="photo">
    <img src="./images/vanilla.png" width="750px" height="400px">
</div>