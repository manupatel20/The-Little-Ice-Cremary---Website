...
<div class="describe">
    <h2>CHOCOLATE SCOOP</h2>
        <p>Chocolate ice cream is prepared with the easy, 
        <br/>all-organic ingredients of cream which is blended  
            <br/>with rich,chunky chocolate chips. It is simply melt 
            <br/> in your mouth,mingling with the luscious 
            <br/>flavors of this real cream.</p>
            <h3>Rs. 60</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="CHOCOLATE SCOOP">
...
<div class="photo">
    <img src="./images/chocolate-lite.png" width="750px" height="400px">
</div>