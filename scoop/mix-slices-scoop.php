...
<div class="describe">
    <h2>MIX SLICES</h2>
        <p>Mixed Slices is beautiful combination of different
            <br/> flavours in one dish. The dish includes chocolate, 
            <br/>strawberry and guava flavoured scoops.</p>
        <h3>Rs. 120</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="MIX SLICES">
...
<div class="photo">
    <img src="./images/mix slices.png" width="750px" height="400px">
</div>