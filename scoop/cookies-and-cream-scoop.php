...
<div class="describe">
    <h2>COOKIES AND CREAM</h2>
        <p>Cookies and cream is a rich and creamy vanilla <br/>
        ice cream stuffed full of chunks of Oreo cookies.<br/>
        Cookies and cream ice cream generally mixes in <br/>crumbled
         chocolate sandwich cookies into vanilla<br/> ice cream, though 
         variations exist which might instead<br/> use chocolate, coffee or mint ice cream.</p>
         <h3>Rs. 65</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="COOKIES AND CREAM">
...
<div class="photo">
    <img src="./images/cookies-and-cream.png" width="750px" height="400px">
</div>