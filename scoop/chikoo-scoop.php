...
<div class="describe">
    <h2>CHIKOO SCOOP</h2>
        <p>Chikoo Ice Cream is a tasty ice cream made from 
            <br/>fresh chikoos with all natural ingredients and strictly
            <br/> no artificial flavours or preservatives.</p>
            <h3>Rs. 55</h3><br/>
        ...
        <form action="<?php echo $action;?>" method="POST">
          <input type="hidden" name="item_name" value="CHIKOO SCOOP">
...
<div class="photo">
    <img src="./images/cheerfully-chikoo.png" width="750px" height="400px">
</div>