...
<div class="describe">
    <h2>ALMOND FUDGE SCOOP</h2>
        <p>This is a melt in your mouth, smooth and <br/>creamy fudge; rich with dark chocolate and almonds.
        <br/>The almond flavor is subtle and it takes a <br/>moment to realize what makes the chocolate <br/>
        flavor special.</p>
        <h3>Rs. 70</h3><br/>
        ...
        <?php
          ...
          <input type="hidden" name="item_name" value="ALMOND FUDGE SCOOP">
...
<div class="photo">
    <img src="./images/almond-fudge.png" width="750px" height="400px">
</div>
